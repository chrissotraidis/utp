...
Pinned provenance and intended use are recorded in
...
Public distribution of a transformed OldUnreal runtime and enabling the
implemented game-data acquisition flow in a public binary remain subject to

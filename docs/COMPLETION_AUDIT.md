...
| Public beta/distribution onboarding | DESIGN SPECIFIED / PERMISSION BLOCKED | TestFlight-first beta, eligible-region Apple web distribution, consent-based authorized game-data acquisition, and physical handoff are specified in `docs/DISTRIBUTION_AND_ONBOARDING.md`. Prebuilt transformed-engine distribution and direct game-data acquisition require explicit permission and Apple channel approval; a raw ad-hoc IPA is not a general public installer. |
